...
public class MemberController {
    ...
    @GetMapping("/me")
    public CommonResponse<MemberResponse> getCurrentUserInfo(Principal principal) {
        MemberResponse memberResponse = memberReadService.getUserDtoByEmail(principal.getName());
